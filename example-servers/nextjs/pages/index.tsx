      ...
      <main className={styles.main}>
        ...
        <div className={styles.components}>
          ...
          <DeepChat
            ...
            connect={{url: '/api/custom/chat-stream'}}
            stream={true}
          />
          <DeepChat
            style={{borderRadius: '10px'}}
        ...
        <div className={styles.components}>
          ...
          <DeepChat
            ...
            connect={{url: '/api/openai/chat', additionalBodyProps: {model: 'gpt-3.5-turbo'}}}
            requestBodyLimits={{maxMessages: -1}}
          ...
          <DeepChat
            ...
            connect={{url: '/api/openai/chat-stream', additionalBodyProps: {model: 'gpt-3.5-turbo'}}}
            stream={true}
            requestBodyLimits={{maxMessages: -1}}
            errorMessages={{displayServiceErrorMessages: true}}
          />
