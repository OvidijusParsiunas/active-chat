...
export class FileAttachmentsType {
  ...
  // prettier-ignore
  constructor(activeChat: ActiveChat, fileAttachments: FileAttachments, toggleContainer: (display: boolean) => void,
    ...
    setTimeout(() => {this._validationHandler = activeChat._validationHandler;});
  }
