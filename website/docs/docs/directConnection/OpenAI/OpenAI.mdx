...
import ContainersKeyToggleChatFunction from '@site/src/components/chat/containersKeyToggleChatFunction';
...
the user sends a new message. This object follows the [OpenAI Create Asssistant API](https://platform.openai.com/docs/api-reference/assistants/createAssistant). <br />
