...
import ComponentContainerHighlightMethod from '@site/src/components/chat/componentContainerHighlightMethod';
import ComponentContainerMethods from '@site/src/components/chat/componentContainerMethods';
...
Dynamically change the text input placeholder text. <br />
